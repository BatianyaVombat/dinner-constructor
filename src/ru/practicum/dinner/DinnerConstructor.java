...
public class DinnerConstructor {
    ...
    public ArrayList<ArrayList<String>> generateCombos(int comboNumber, ArrayList<String> dishTypes) {
        ...
        for (int i = 0; i <= comboNumber; i++) {
            ArrayList<String> combo = generateOneCombination(dishTypes); //одна комбинация блюд генерируется в отдельном методе
            combos.add(combo);
        }
        return combos;
    }
    ...
    private ArrayList<String> generateOneCombination(ArrayList<String> dishTypes) {
