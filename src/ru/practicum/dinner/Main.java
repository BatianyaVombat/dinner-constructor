...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (command) {
                case "1":
                    /*dc.addNewDish("Первое", "Щи");
                    dc.addNewDish("Первое", "Борщ");
                    dc.addNewDish("Первое", "Гороховый");
                    dc.addNewDish("Первое", "Солянка");
                    dc.addNewDish("Второе", "Котлетка с пюре");
                    dc.addNewDish("Второе", "Курочка");
                    dc.addNewDish("Второе", "Драники");
                    dc.addNewDish("Второе", "Макароны по флотски");
                    dc.addNewDish("Второе", "Яичница глазунья");
                    dc.addNewDish("Сок", "Яблочный сок");
                    dc.addNewDish("Сок", "Апельсиновый сок");
                    dc.addNewDish("Салат", "Греческий");
                    dc.addNewDish("Салат", "Оливье");
                    dc.addNewDish("Салат", "Мимоза");*/
                    addNewDish();
                    break;
                case "2":
                    generateDishCombo();
